...
describe('add preclusion course success', () => {
    ...
    it('add preclusion course', function () {
        cy.get(':nth-child(2) > .el-card > .el-card__header > .clearfix > .el-button > span').click()
        cy.wait(300)
        ...
        cy.wait(600)
        cy.get('[style="min-width: 151.172px; position: fixed; top: 216px; left: 1104px; transform-origin: center top; z-index: 2015;"] > .el-scrollbar > .el-select-dropdown__wrap > .el-scrollbar__view > :nth-child(3)').click()
        cy.wait(600)

        cy.get('.demo-drawer__content > .el-card > .el-card__header > .clearfix > .el-button-group > .el-button--primary > span').click()
        cy.wait(600)
